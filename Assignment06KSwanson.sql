...
-- 2017-01-01,KSwanson,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_KSwanson')
	 Begin 
	  Alter Database [Assignment06DB_KSwanson] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_KSwanson;
	 End
	Create Database Assignment06DB_KSwanson;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_KSwanson;
